(function(g, b) {
    ...
    var e = { elements: d.elements || "abbr article aside audio bdi canvas data datalist Show figcaption figure footer header hgroup mark meter nav output progress section summary time video", shivCSS: !1 !== d.shivCSS, shivMethods: !1 !== d.shivMethods, type: "default", shivDocument: h };
    g.html5 = e;
    h(b);
})(this, document);